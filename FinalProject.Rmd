...
## CForest
The final method I used to estimate INTP was CForest. CForest was used to estimate $\hat{y_i}$ and then the imputation formula was applied. Like CTREE, CForest is unable to handle missing values in the response variable, so these rows have been removed from the analysis.
