...
write_csv(clean.data.2, "cleanData.csv") #export clean data file to use in guide
...
```{r data cleansing phase three}
#exclude variables found to be unimportant by guide from clean.data.2 to make clean.data.3
#use guide subset function (as seen open in power point right now, slide 89 )
```


#to do
clean data further from information provided by guide importance scoring
