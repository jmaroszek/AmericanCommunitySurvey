...
```{r Creating GUIDE Description File + Var Type Update}
#Use Data description file from ACS to determine var type

#create vector of sampling weights to exclude in GUIDE file
...
#Change to correct column types in data frame
```
