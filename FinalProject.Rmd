...
rf.y = rf.data$INTP
rf.miss = is.na(rf.y)
rf.est = (sum(rf.w[!rf.miss]*rf.y[!rf.miss])+sum(rf.w[rf.miss]*yhat[rf.miss]))/sum(rf.w) + 25
...
logisitc cctree and random forest all give same estimate. Whats going on with that?
